...
fs.copyFileSync(path.join(ROOT, "tree-preview.html"), path.join(OUT, "tree-preview.html"));
fs.copyFileSync(path.join(ROOT, "terrain-preview.html"), path.join(OUT, "terrain-preview.html"));   // 地形预览入口   // 树木样板入口
