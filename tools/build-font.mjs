...
fs.writeFileSync("fonts/brush-tour.js", `/* 马善政毛笔楷书 · 标题与巡游子集（SIL OFL 1.1），由 tools/build-font.mjs 生成 */
(function(){try{var s=atob("${buf.toString("base64")}"),u=new Uint8Array(s.length);for(var i=0;i<s.length;i++)u[i]=s.charCodeAt(i);var f=new FontFace("ShanheBrush",u.buffer,{display:"swap"});document.fonts.add(f);f.load()}catch(e){}})();
`);
