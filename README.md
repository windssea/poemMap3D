...
- **市井生机**（`engine/effects/LifeSystem.ts`）：镜头推近一处地方时，街巷行人、摊贩与看货人、屋顶炊烟、盘旋飞鸟；附近江河湖上渔舟、客船、画舫，沿海明代福船式海船。船浮在脚下真实的水面上（取船头、船腰、船尾三处水面最高者）：江河穿湖处随湖面、河渠跌水处随水位，驶上高一级水面立刻浮起，不会沉进水下。瀑下深潭、园林小池这类小水景（营造的湖面积不足 300、天然湖不足 400 格）不放船。全是方块拼成的小模型：士人（幞头、交领广袖长袍）、女子（高髻金簪、襦裙披帛）、劳作者（斗笠短褐），渔舟上有垂钓的渔翁，客船上有摇橹的艄公。
