...
- **地标**：手工营造——杭州、庐山、长安；名楼黄鹤楼（蛇山、十字抱厦十字脊）、岳阳楼（城台盔顶面洞庭）、滕王阁（高台挟屋面赣江）、鹳雀楼、多景楼（北固山甘露寺）；名城金陵（秦淮、夫子庙、钟山、报恩寺琉璃塔、凤凰台）、洛阳（洛水穿城、天津桥、明堂、南市、白马寺）、成都（散花楼、锦江万里桥、草堂、武侯祠）、苏州（水巷拱桥、园林水榭游廊假山、北寺塔）。其余地点按诗作多少与地名自动成聚落（楼、阁、台、亭、寺各有形制，以山为名的在山巅设重檐亭）；长城为沿山脊的线性结构。落在江心的名楼自动挪到岸上，洛阳这类允许江河穿城，城墙在水上留水门，桥自动找河跨过。
...
- **光影**：画质「衡」「高」有泛光，入夜灯笼、窗光柔和晕开；阴影在光源空间按像素对齐（不爬动闪烁），「高」为软阴影；远景的窗不整块发光。
